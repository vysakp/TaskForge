...
import (
	...
	pb "github.com/vysakp/TaskForge/pkg/grpcapi"
...
func (s *CoordinatorServer) Start() error {
	var err error
	go s.manageWorkerPool()// for keeping track which workers are still active and which workers needs 
	//to be removed from the worker pool 
